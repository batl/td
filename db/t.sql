...
# Dumping structure for table template.wp_commentmeta
...
# Dumping data for table template.wp_commentmeta: 0 rows
/*!40000 ALTER TABLE `wp_commentmeta` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_commentmeta` ENABLE KEYS */;


# Dumping structure for table template.wp_comments
...
# Dumping data for table template.wp_comments: 1 rows
/*!40000 ALTER TABLE `wp_comments` DISABLE KEYS */;
INSERT INTO `wp_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
	(1, 1, 'Mr WordPress', '', 'http://wordpress.org/', '', '2012-05-23 19:31:14', '2012-05-23 19:31:14', 'Hi, this is a comment.<br />To delete a comment, just log in and view the post&#039;s comments. There you will have the option to edit or delete them.', 0, '1', '', '', 0, 0);
/*!40000 ALTER TABLE `wp_comments` ENABLE KEYS */;


# Dumping structure for table template.wp_links
...
# Dumping data for table template.wp_links: 7 rows
...
# Dumping structure for table template.wp_options
...
# Dumping data for table template.wp_options: 105 rows
/*!40000 ALTER TABLE `wp_options` DISABLE KEYS */;
INSERT INTO `wp_options` (`option_id`, `blog_id`, `option_name`, `option_value`, `autoload`) VALUES
	(1, 0, '_site_transient_timeout_theme_roots', '1337808674', 'yes'),
	(2, 0, '_site_transient_theme_roots', 'a:2:{s:12:"twentyeleven";s:7:"/themes";s:9:"twentyten";s:7:"/themes";}', 'yes'),
	(3, 0, 'siteurl', 'http://template.loc', 'yes'),
	(4, 0, 'blogname', 'template', 'yes'),
	(5, 0, 'blogdescription', 'Just another WordPress site', 'yes'),
	(6, 0, 'users_can_register', '0', 'yes'),
	(7, 0, 'admin_email', 'maxdmitrief@gmail.com', 'yes'),
	...
	(39, 0, 'home', 'http://template.loc', 'yes'),
...
# Dumping structure for table template.wp_postmeta
...
# Dumping data for table template.wp_postmeta: 1 rows
...
# Dumping structure for table template.wp_posts
...
# Dumping data for table template.wp_posts: 2 rows
/*!40000 ALTER TABLE `wp_posts` DISABLE KEYS */;
INSERT INTO `wp_posts` (`ID`, `post_author`, `post_date`, `post_date_gmt`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `ping_status`, `post_password`, `post_name`, `to_ping`, `pinged`, `post_modified`, `post_modified_gmt`, `post_content_filtered`, `post_parent`, `guid`, `menu_order`, `post_type`, `post_mime_type`, `comment_count`) VALUES
	(1, 1, '2012-05-23 19:31:14', '2012-05-23 19:31:14', 'Welcome to WordPress. This is your first post. Edit or delete it, then start blogging!', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2012-05-23 19:31:14', '2012-05-23 19:31:14', '', 0, 'http://template.loc/?p=1', 0, 'post', '', 1),
	(2, 1, '2012-05-23 19:31:14', '2012-05-23 19:31:14', 'This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my blog. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickies to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href="http://template.loc/wp-admin/">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'publish', 'open', 'open', '', 'sample-page', '', '', '2012-05-23 19:31:14', '2012-05-23 19:31:14', '', 0, 'http://template.loc/?page_id=2', 0, 'page', '', 0);
/*!40000 ALTER TABLE `wp_posts` ENABLE KEYS */;


# Dumping structure for table template.wp_terms
...
# Dumping data for table template.wp_terms: 2 rows
...
# Dumping structure for table template.wp_term_relationships
...
# Dumping data for table template.wp_term_relationships: 8 rows
...
# Dumping structure for table template.wp_term_taxonomy
...
# Dumping data for table template.wp_term_taxonomy: 2 rows
...
# Dumping structure for table template.wp_usermeta
...
# Dumping data for table template.wp_usermeta: 13 rows
...
# Dumping structure for table template.wp_users
...
# Dumping data for table template.wp_users: 1 rows
/*!40000 ALTER TABLE `wp_users` DISABLE KEYS */;
INSERT INTO `wp_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES
	(1, 'admin', '$P$BZ0dscJDxBgv03thLPcbEFj9JA.Oub1', 'admin', 'maxdmitrief@gmail.com', '', '2012-05-23 19:31:14', '', 0, 'admin');
